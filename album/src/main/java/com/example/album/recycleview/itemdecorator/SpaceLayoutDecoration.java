...
public class SpaceLayoutDecoration extends RecyclerView.ItemDecoration {
  ...
  private int span;
  private boolean showHeaderViewSpace = true;

  private SpaceLayoutDecoration(@Orientation int type, int span, int linearSpace, int gridSpace,
      int headCut, int tailCut, int leftCut, int rightCut, int rowSpace, int columnSpace,boolean showHeaderViewSpace) {
    this.type = type;
    ...
    this.span = span;
    this.showHeaderViewSpace = showHeaderViewSpace;
  }
  ...
  public void setShowHeaderViewSpace(boolean showHeaderViewSpace){
    this.showHeaderViewSpace = showHeaderViewSpace;
  }
  ...
  private void layoutVertical(Rect outRect, int position, int lastPosition) {
    if (position == 0 && !showHeaderViewSpace) {
      outRect.top = 0;
      outRect.bottom = 0;
    }else {
      outRect.top = 0;
  ...
  public static class Builder {
    ...
    /**
     * headerView下面是否要显示分割线
     * @param showHeaderViewSpace
     * @return
     */
    public Builder showHeaderViewSpace(boolean showHeaderViewSpace){
      this.showHeaderViewSpace = showHeaderViewSpace;
      return this;
    }
    ...
    public SpaceLayoutDecoration build() {
      ...
      return new SpaceLayoutDecoration(type, span, linearSpace, gridSpace, headCut, tailCut,
          leftCut, rightCut, rowSpace, columnSpace,showHeaderViewSpace);
    }
  }
}
