...
public class GlideImageView extends ShapeImageView {
    ...
    public GlideImageView loadImage(@DrawableRes int resId, int placeholderResId) {
        getImageLoader().loadImage(resId, placeholderResId);
        return this;
    }


    public GlideImageView loadCircleImage(String urlOrPath, int placeholderResId) {
        setCircle(true);
        getImageLoader().loadCircleImage(urlOrPath, placeholderResId);
        return this;
    }

    public GlideImageView loadCircleImage(int resId, int placeholderResId) {
        setCircle(true);
        getImageLoader().loadCircleImage(resId, placeholderResId);
        return this;
    }
