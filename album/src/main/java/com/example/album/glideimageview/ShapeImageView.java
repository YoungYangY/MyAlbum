...
public class ShapeImageView extends AppCompatImageView {
    ...
    private boolean mIsNotAllCornerRadius = false;
    ...
    public ShapeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIsNotAllCornerRadius = array.getBoolean(R.styleable.ShapeImageViewStyle_riv_not_all_corner_radius,false);
        mLeftTopCornerRadius = array.getDimensionPixelSize(R.styleable.ShapeImageViewStyle_riv_left_top_corner_radius,0);
        mLeftBottomCornerRadius = array.getDimensionPixelSize(R.styleable.ShapeImageViewStyle_riv_left_bottom_corner_radius,0);
        mRightTopCornerRadius = array.getDimensionPixelSize(R.styleable.ShapeImageViewStyle_riv_right_top_corner_radius,0);
        mRightBottomCornerRadius = array.getDimensionPixelSize(R.styleable.ShapeImageViewStyle_riv_right_bottom_corner_radius,0);
        array.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsCircle) {
            ...
            float[] rids = {mLeftTopCornerRadius,mLeftTopCornerRadius,mRightTopCornerRadius,mRightTopCornerRadius,
    ...
    public void setPartCornerRadius(float [] radius){
        mIsCircle = false;
        mIsNotAllCornerRadius = true;
        mLeftTopCornerRadius = radius[0];
        mRightTopCornerRadius = radius[2];
        mRightTopCornerRadius = radius[4];
        mLeftBottomCornerRadius = radius[6];
        requestLayout();
        invalidate();
    }
